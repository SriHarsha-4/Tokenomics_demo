...
const ContactInfo = () => {
  return (
    <section className="m-20">
      <div className="max-w-screen-lg mx-auto p-5 shadow-xl">
        <div className="grid grid-cols-1 md:grid-cols-12 border">
          ...
          <form className="md:col-span-8 p-10">
            ...
            <div className="flex w-full px-3 justify-end">
              <button
                type="submit"
                className="shadow bg-gray-900 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
              >
                Send Message
              </button>
            </div>
