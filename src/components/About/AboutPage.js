...
const AboutPage = () => {
  return (
    <section className='mx-40 my-20'>
      <div class="bg-white relative   flex items-center  n justify-center overflow-hidden">
          ...
          <div class="flex flex-col items-center justify-between lg:flex-row py-16">
            <div class=" relative ">
              ...
              <div class="lg:max-w-xl lg:pr-5 relative z-40">
                <p class="flex text-sm uppercase text-g1  ">About Us</p>
                ...
                <div class="mt-10 flex flex-col items-center md:flex-row">
                  <a
                    href="/"
                    class="font-bold mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-gray-900 px-6 tracking-wide text-white shadow-md transition focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                  >
                    View More
                  </a>
                  <a
            ...
            <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
              ...
              <div class="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                <img src="https://placehold.co/400x400" alt="sfsrt" />
              </div>
            </div>
          </div>
        </div>
