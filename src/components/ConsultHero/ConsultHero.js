...
const ConsultHero = () => {
  return (
    <div>
      <section class="pt-28 mx-40">
        <div class="container mx-auto px-8 lg:flex">
          <div class="text-center lg:text-left lg:w-1/2">
            <h1 class="text-5xl font-semibold">
              How can we help your project?
            </h1>
            <p class="text-xl mt-6 font-light">
              In the rapidly evolving world of cryptocurrencies and blockchain
              technology, having a trusted partner to help you navigate the
              complexities of tokenomics is essential. At The Tokenomics Agency,
              our expert consulting services provide you with the knowledge,
              insights, and guidance needed to make informed decisions, ensuring
